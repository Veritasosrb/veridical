...
//public class accessbile everywhere consist code to check whether the sentence consist of marker or not.
public class frame_structure_marker {
	// First regular expression consist of compulsory dependancy called as advmod is adverb modifier
	// which tells about marks
	...
	// sentence
	public Map<String,String> frame_marker(String sl, String k1) throws Exception {
		// frame structure for marker
		...
		// Here false indicates that there no advmod present in sentence so need to check
		// further for second regular expression and no marker present in sentence
		if (m.find() == false) {
