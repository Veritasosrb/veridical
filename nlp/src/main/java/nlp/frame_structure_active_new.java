...
public class frame_structure_active_new {
	...
	private static final String REGEX = "(.*)(\\bnsubj\\b)(.*)";
	...
	private static final String REGEX2 = "(NN)";
	private static final String REGEX3 = "(VB)";
	...
	// sentence
	public void frame_active_new(String sl, String k1) throws Exception {
