...
public class selenium {
	...
	public static void main(String[] args) {
		...
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\aditi.inamdar\\Downloads\\chromedriver_win32\\chromedriver.exe");
		...
		System.out.print(s);
		 CSVWriter writer = new CSVWriter(new FileWriter("C:\\Users\\aditi.inamdar\\Documents\\UserStoryJiraNew2.csv"));
