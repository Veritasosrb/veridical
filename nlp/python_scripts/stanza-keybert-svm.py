...
def runall(test):
  ...
  print("Stanza Verbs : ", stanza_verb)
  print("Stanza Adjective : ", stanza_adj)
  ...
  with open(path+"\\Dictionaries\\dictionary.csv", "a") as f:
      writer = csv.writer(f)
      for i in dict1:
          writer.writerow([i])
  f.close()
  ...
  df = pd.read_csv(path+"\\Dictionaries\\dictionary.csv")
